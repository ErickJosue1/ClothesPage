      ...
      <div class="w-full h-full overflow-x-hidden">
        <div class=" flex items-end lg:flex-row flex-col justify-center">
          ...
          <div
            ...
            id="scroll">
            <div class="flex items-center hover:text-gray-600 cursor-pointer"
              ...
              <a :href="route('public')" class="text-sm pl-2 leading-none">Back</a>
            </div>
            <p class="lg:text-4xl text-3xl font-black leading-10 py-3">Bag</p>
            <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
              ...
              <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                ...
                <div class="flex items-center justify-between w-full pt-1">
                  <p class=" font-black leading-none">North wolf bag</p>
            ...
            <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
              ...
              <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                ...
                <div class="flex items-center justify-between w-full pt-1">
                  ...
                  <select aria-label="Select quantity" class="py-2 px-3 border bg-secondary-content border-gray-200 mr-6 focus:outline-none">
                    <option>01</option>
                    <option>02</option>
                    <option>03</option>
                  </select>
          ...
          <div class="w-full bg-base-300 h-full">
            <div
              ...
              <div>
                <p class="lg:text-4xl text-3xl font-black leading-9">Summary</p>
                <div class="flex items-center justify-between pt-16">
                  <p class="text-base leading-none">Subtotal</p>
                  <p class="text-base leading-none">$9,000</p>
                </div>
                <div class="flex items-center justify-between pt-5">
                  <p class="text-base leading-none">Shipping</p>
                  <p class="text-base leading-none">$30</p>
                </div>
                <div class="flex items-center justify-between pt-5">
                  <p class="text-base leading-none">Tax</p>
              ...
              <div>
                <div class="flex items-center pb-6 justify-between lg:pt-5 pt-20">
                  ...
                  <p class="text-2xl font-bold leading-normal text-right">$10,240</p>
                </div>
