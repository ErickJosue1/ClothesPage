<template>
  <GuestLayout> <!-- Content -->
    <div class="border-y-4 w-full h-full bg-black bg-opacity-90 overflow-y-auto overflow-x-hidden">
      <div class="w-full h-full overflow-x-hidden">
        <div class=" flex items-end lg:flex-row flex-col justify-center">

          <!-- Items -->
          <div
            class="w-full lg:px-8 lg:py-14 md:px-6 px-4 md:py-8 py-4 bg-white overflow-y-auto overflow-x-hidden lg:h-screen h-auto"
            id="scroll">
